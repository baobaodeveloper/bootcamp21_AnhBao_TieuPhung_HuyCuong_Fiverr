      ...
      <div className='container px-6 space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50'>
        <div className='flex lg:justify-between flex-wrap justify-center  text-center  pt-6 '>
          ...
          <div className='flex justify-center pt-4 flex-wrap space-x-2 lg:pt-0 lg:col-end-13'>
            ...
            <div className=' text-whitecursor-pointer justify-center flex items-center text-xl font-semibold  gap-x-1 h-10 w-32 hover:bg-gray-300 rounded-full transition-all'>
              <RiEarthLine />
              <span>English</span>
            </div>
            <div className=' text-white cursor-pointer justify-center flex items-center text-xl font-semibold   h-10 w-32 hover:bg-gray-300 rounded-full transition-all'>
              US$ USD
            </div>
            <div className=' text-white cursor-pointer justify-center flex items-center text-xl font-semibold   h-10 w-10 hover:bg-gray-300 rounded-full transition-all border border-gray-500 hover:border-white'>
              <ImAccessibility />
            </div>
          </div>
        </div>
